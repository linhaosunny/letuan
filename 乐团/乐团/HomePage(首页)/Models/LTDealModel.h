...
@class LTRestrictionsModel,LTBusinessesModel;

@interface LTDealModel : NSObject
...
// > 团购限制条件
@property (nonatomic, strong) LTRestrictionsModel *restrictions;
// > 商家
@property (nonatomic, strong) NSArray <LTBusinessesModel *> * businesses;
// > 类别
