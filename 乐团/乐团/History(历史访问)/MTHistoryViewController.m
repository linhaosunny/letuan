//
//  MTHistoryViewController.m
//  乐团
//
//  Created by 李莎鑫 on 2017/3/2.
...
@interface MTHistoryViewController () <MTDealCellDelegate>
...
@implementation MTHistoryViewController
...
- (void)loadDealsFromDataBase{
    ...
    // > 新增数据
    [self.deals addObjectsFromArray:[MTDealTool recentDealsWithNumofPage:MTDataBaseDealPerPageNum withPage:self.currentPage]];
