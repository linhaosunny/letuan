...
#import "LTDealsViewController.h"
#import "LTNetWorkRequestModel.h"
...
@property (nonatomic, weak) LTNetWorkParamsModel *data;

@property (nonatomic, strong) NSMutableArray *deals;
@property (nonatomic, strong) LTNetWorkRequestModel *request;
...
- (LTNetWorkRequestModel *)request{
    if(!_request){
        _request = [[LTNetWorkRequestModel alloc] init];
    }
...
- (void)loadNetworkServersNewData:(LTNetWorkParamsModel *) data withClearUpdate:(BOOL) clear{
...
//    DebugLog(@"请求参数：%@",params);
    ...
    [[LTHttpTool sharedHttpTool] httpToolRequestWithURL:@"v1/deal/find_deals" params:params successWithResult:^(DPRequest *request,id result) {
    ...
    [[LTHttpTool sharedHttpTool] httpToolRequestWithURL:@"v1/metadata/get_categories_with_deals" params:nil successWithResult:^(DPRequest *request,id result) {
